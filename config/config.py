...
BOT_TOKEN = getenv("BOT_TOKEN", "7037725089")
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","larisa")
...
UPSTREAM_REPO = getenv(
    ...
    "https://github.com/Yukki21090/Larisa",
