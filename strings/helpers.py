...
⏭️ **/ilerisar :** Müziği İleri Sarar. (Örnek: /ilerisar 15 İle Çalan Müziği 15 Saniye İleri Alabilirsiniz.)
⏮️ **/seekback :** Müziği Geri Sarar. (Örnek: /seekback 15 İle Çalan Müziği 15 Saniye Geri Alabilirsiniz.)
...
❤️‍🩹 **/playlist :** Oynatma Listenizde Hangi Müziklerin Olduğuna Bakabilirsiniz.
...
🗨️ **/sarkisozu [Müzik Adı] :** Sözlerine Bakmak İstediğiniz Şarkıyı Arayabilirsiniz.
...
**Örnek:** `/broadcast -user -assistant -pin Göktuğ`
